...
export default function HomePage() {
  ...
  const markAttendance = async (course) => {
    try {
        ...
        navigator.geolocation.getCurrentPosition(
            async (position) => {
                try {
                    ...
                    const response = await axios.post("http://localhost:5001/api/attendance/markAttendance", {
                      courseCode: course.courseCode,
                      courseName: course.courseName,
                      latitude,
                      longitude
                    ...
                    alert(`Attendance marked for ${course.courseCode}`);
                } catch (error) {
                  console.log("OOOO")
                ...
                .map((item, index) => (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      <Button variant="primary" onClick={() => markAttendance(item)}>
                        Mark Attendance
                      </Button>
                    </td>
                  </tr>
